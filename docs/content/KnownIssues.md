...
If `https://945040ad.com/win` is not working, or you want to download the code from GitHub directly, you can use the direct download link:

```
irm https://github.com/945040ad/Winutil/releases/latest/download/Winutil.ps1 | iex
```
...
iex https://945040ad.com/win | iex
```
...
Related issue: [#69](https://github.com/945040ad/Winutil/issues/69)

### Windows Search does not work

Enable Background Apps. Related issues: [#69](https://github.com/945040ad/Winutil/issues/69) [#95](https://github.com/945040ad/Winutil/issues/95) [#232](https://github.com/945040ad/Winutil/issues/232)
...
Related issue: [#198](https://github.com/945040ad/Winutil/issues/198)
